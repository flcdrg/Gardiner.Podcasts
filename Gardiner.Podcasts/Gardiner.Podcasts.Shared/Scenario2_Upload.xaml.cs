...
namespace Gardiner.Podcasts
{
    ...
    public sealed partial class S2_Upload : Page, IDisposable, IFileOpenPickerContinuable
#else
    public sealed partial class S2_Upload : Page, IDisposable
#endif
    {
